...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        ...
        new WeatherDataGetter().execute(location);
    }

    private class WeatherDataGetter extends AsyncTask<String, Void, String[]> {
        @Override
        ...
        protected void onPostExecute(String[] strings) {
            if (strings == null) {
                mWeatherTextView.setText("Error occured. Please try again.");
            }

            for (String d: strings) {
                mWeatherTextView.append(d + "\n\n\n");
            }
        }
    }
}